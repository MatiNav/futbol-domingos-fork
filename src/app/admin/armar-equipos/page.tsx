              ...
              {Array(8)
                ...
                .map((_, index) => (
                  <tr key={index} className="border-t">
                    ...
                    <td className="px-4 py-2 bg-cyan-100">
                      <div className="relative">
                        <input
                          type="text"
                          ...
                          className="w-full p-2.5 text-gray-800 bg-cyan-100 border-2 border-blue-400 rounded-lg shadow-sm 
                          focus:border-blue-500 focus:ring-2 focus:ring-blue-400 
                          appearance-none cursor-pointer hover:bg-cyan-200 transition-colors pr-10
                        ...
                        {searchTerms[index].team2 && !team2[index] && (
                          <div className="absolute z-10 w-full mt-1 rounded-lg shadow-lg max-h-48 overflow-y-auto bg-white border-2 border-blue-400">
                            {getFilteredPlayers(
                              ...
                              <div
                                key={player._id}
                                className="px-4 py-2 hover:bg-cyan-50 cursor-pointer text-gray-800 border-b border-blue-200 last:border-b-0"
                                onClick={() =>
